...
*******************************************************************************************************************
If you downloading project from repository, you have to include some js and css libraries to make it work properly.
...
*******************************************************************************************************************
Settings for jdbc and email registration confirmation  are located in "src\main\resources\properties" directory.
*******************************************************************************************************************
There may be some issues with libraries located within Tomcat lib folder and jdbc connector jar if different 
